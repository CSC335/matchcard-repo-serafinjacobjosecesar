...
public class Profile extends BorderPane {
	...
	private void configLayout() {
		...
		changePasswordButton.setOnAction(event2 -> {
			...
			String InvalidPassPromptStyle = "-fx-text-fill: #900D09; " + "-fx-font-size: 30px;";
			...
			if (newPass.equals("")) {
				...
				String passPromptStyle = "-fx-text-fill: white; " + "-fx-font-size: 30px;";
		...
		statsPane.getChildren().addAll(passwordChangePrompt, user, bestTimeG1, G1BestTime, bestTimeG2, G2BestTime,
				longestStreak, highscore, profileMainMenu, newPasswordField, changePasswordButton);
