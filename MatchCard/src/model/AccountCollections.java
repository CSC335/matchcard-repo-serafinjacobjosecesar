...
/**
 * AccountCollections acts as the collection class for accounts uses ArrayList
 * as underlining data structure
 */
public class AccountCollections implements Serializable {
	private ArrayList<Account> accounts;

	/**
	 * AccountCollections constructor for collection class initializes accounts - an
	...
	/**
	 * contains checks to see if the Account taken as argument is contained in
	 * collections
	 * 
	 * @param accountToCheck Account is an account object to verify if it is in
	 *                       accountCollections
