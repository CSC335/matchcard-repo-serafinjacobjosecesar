...
public class Number {
	...
	// Constructor used for the numbers with their data.
	...
	// Constructor method to calculate whther number is in the firstEighteen
	// positions.
	...
	// 1 = column starting with 1, 2 = column starting with 2 3 = column starting
	// with 3.
