...
/**
 * Account class that represents the user's account tracks longest streak,
 * current streak, high score, current score and points.
 */
public class Account implements Serializable {
	...
	/**
	 * verifyPassword verify that the supplied password matches the account recorded
	 * password.
	 * 
	...
	/**
	 * updateCurrScore uses current Boolean value assigned to hadMatch to determine
	 * if current score, points, and streak need to be updated or if current streak
	 * needs to be reset
	 */
